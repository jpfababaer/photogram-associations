...
class User < ApplicationRecord
  ...
  #1 User#comments: returns rows from the comments table associated to this user by the author_id column. Whe we say has_many = Class (One, i.e. User) has_many Query table (Many) -> One-to-Many.
  ...
  #------------------------------------------------------
  #3 User#likes: returns rows from the likes table associated to this user by the fan_id column
  ...
  #------------------------------------------------------
  #5 User#own_photos: returns rows from the photos table  associated to this user by the owner_id column
  ...
  #------------------------------------------------------
  #6 User#sent_follow_requests: returns rows from the follow requests table associated to this user by the sender_id column
  ...
  #------------------------------------------------------
  #7 User#received_follow_requests: returns rows from the follow requests table associated to this user by the recipient_id column
  ...
  #8 User#liked_photos: returns rows from the photos table associated to this user through its likes. Return the MANY photos a User liked.
  ...
  # end
  #------------------------------------------------------
  #9 User#commented_photos: returns rows from the photos table associated to this user through its comments
  ...
  #------------------------------------------------------
  #10 
  has_many(:photos_liked, through: :likes)
